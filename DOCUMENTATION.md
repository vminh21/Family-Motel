# 📘 TÀI LIỆU CẤU TRÚC DỰ ÁN VÀ HƯỚNG DẪN TRIỂN KHAI (DEPLOYMENT GUIDE)
**Dự án**: Hệ Thống Quản Lý Phòng Trọ Gia Đình (Family Motel Management)

Tài liệu này hướng dẫn chi tiết về cấu trúc mã nguồn, luồng hoạt động của hệ thống và các bước triển khai chi tiết từ môi trường phát triển (Local Development) lên môi trường chạy thực tế (Production) bằng các dịch vụ đám mây miễn phí (Vercel + Render + Aiven).
...
## 💻 3. Hướng Dẫn Chạy Thử Ở Máy Local (Local Development)
